...
describe 'managedmac::authorization', type: 'class' do
  ...
  context 'when at least one parameter == true' do
    ...
    it do
      is_expected.to contain_macauthdb('system.preferences').with(
        'group' => 'everyone',
      )
    end
  end
  ...
  context 'when $allow_energysaver == true' do
    ...
    it do
      is_expected.to contain_macauthdb('system.preferences.energysaver').with(
        'group' => 'everyone',
      )
    end

    it do
      is_expected.to contain_macauthdb('system.preferences.datetime').with(
        'group' => 'admin',
      )
    end

    it do
      is_expected.to contain_macauthdb('system.preferences.timemachine').with(
        'group' => 'admin',
      )
    end
  end
  ...
  context 'when $allow_printers == true' do
    ...
    it do
      is_expected.to contain_macauthdb('system.preferences.printing').with(
        'group' => 'everyone',
      )
    end
  end
  ...
  context 'when $allow_dvd_setregion_initial == true' do
    ...
    it do
      is_expected.to contain_macauthdb('system.device.dvd.setregion.initial').with(
        'auth_class' => 'user',
      )
    end
  end
